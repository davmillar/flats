...
Certain special types of transposals have their own names: the [**head-to-tail shift**](base/head-to-tail-shift) (the first letter becomes the last), the [**letter shift**](base/letter-shift) (one letter moves to a new place), the [**metathesis**](base/metathesis) (two letters exchange places), the [**reversal**](base/reversal) (the letter order is reversed), and the [**transpogram**](base/transpogram) (a word or phrase is divided into two pieces, which exchange places). These are described under their own titles.
